        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/dashboard" className="text-gray-300 hover:text-white transition">Login</Link>
              <Link href="/groups/new" className="px-5 py-2.5 bg-blue-500 hover:bg-blue-600 rounded-lg font-medium transition">
                Get Started
              </Link>
            </div>
            ...
            <div className="flex md:hidden items-center gap-3">
              <Link href="/dashboard" className="text-gray-300 hover:text-white transition text-sm">Login</Link>
              <Link href="/groups/new" className="px-4 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg font-medium transition text-sm">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-8">
                <Link href="/groups/new" className="px-8 py-4 bg-blue-500 hover:bg-blue-600 rounded-lg font-semibold transition">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-[#1a2738] rounded-2xl p-8 border border-gray-800/50">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Create groups for trips, households, or dinners in seconds. Add members via a simple link or QR code.
              </p>
            </div>
            ...
            <div className="bg-[#1a2738] rounded-2xl p-8 border border-gray-800/50">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Whether it's equal splits, percentages, or specific amounts, our engine handles the complex math for you.
              </p>
            </div>
            ...
            <div className="bg-[#1a2738] rounded-2xl p-8 border border-gray-800/50">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Stay in the loop with a real-time feed of every expense added, edited, or settled up by anyone in the group.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-[#1a2738]/60 rounded-3xl p-12 text-center border border-gray-700/30">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/groups/new" className="px-8 py-3.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold transition shadow-lg">
                Get Started Now
              </Link>
              <Link href="#features" className="px-8 py-3.5 bg-transparent hover:bg-gray-700/30 text-white rounded-lg font-semibold transition border border-gray-600/50">
                Learn More
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
